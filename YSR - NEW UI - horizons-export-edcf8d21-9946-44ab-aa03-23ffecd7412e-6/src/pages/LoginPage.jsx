...
const LoginPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Artist Login - Your Song Request</title>
        <meta name="description" content="Login to your artist account and manage your song requests, setlist, and performances." />
        <meta property="og:title" content="Artist Login - Your Song Request" />
        <meta property="og:description" content="Login to your artist account and manage your song requests, setlist, and performances." />
      </Helmet>
        ...
        >
          ...
          <Card className="glass-effect border-gray-800">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl font-bold text-white">Artist Login</CardTitle>
